...
Entry* probe(const Position& pos) {
  ...
  Entry* e = pos.thread_tls()->materialTable[key];
  ...
  if ((e->evaluationFunction = pos.thread_tls()->endgames.probe<Value>(key)) != nullptr)
      return e;
  ...
  if ((sf = pos.thread_tls()->endgames.probe<ScaleFactor>(key)) != nullptr)
  {
