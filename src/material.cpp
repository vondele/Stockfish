...
Entry* probe(const Position& pos) {
  ...
  Entry* e = pos.this_thread()->evalTables->materialTable[key];
  ...
  if ((e->evaluationFunction = pos.this_thread()->evalTables->endgames.probe<Value>(key)) != nullptr)
      return e;
  ...
  if ((sf = pos.this_thread()->evalTables->endgames.probe<ScaleFactor>(key)) != nullptr)
  {
