...
ScaleFactor Endgame<KRPKR>::operator()(const Position& pos) const {
  ...
  return ScaleFactor(params[0]
          +  params[1] * relative_rank(strongSide, psq)
          -  params[2] * distance(strongksq, queeningSq)
          +  params[3] * distance(weakksq, queeningSq));
}
