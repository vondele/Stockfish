...
int Position::set_from_packed_sfen(const Tools::PackedSfen& sfen , StateInfo* si, Thread* th, bool is_frc)
{
  return Tools::set_from_packed_sfen(*this, sfen, si, th, is_frc);
}
