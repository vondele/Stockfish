...
moves_loop: // When in check, search starts here
    ...
    Move countermove = thisThread->counterMoves[bool(pos.square<KING>(us) & DarkSquares)][pos.piece_on(prevSq)][prevSq];
  ...
  void update_quiet_stats(const Position& pos, Stack* ss, Move move, int bonus, int depth) {
    ...
    {
        Square prevSq = to_sq((ss-1)->currentMove);
        thisThread->counterMoves[bool(pos.square<KING>(us) & DarkSquares)][pos.piece_on(prevSq)][prevSq] = move;
    }
