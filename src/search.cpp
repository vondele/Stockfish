...
extern Value Eval::Contempt[COLOR_NB];
...
void MainThread::search() {
  ...
  Eval::Contempt[ us] =  Value(base_contempt);
  Eval::Contempt[~us] = -Value(base_contempt);

  Phase phase = Material::probe(rootPos)->game_phase();
  DrawValue[ us] = VALUE_DRAW - Eval::contempt(phase, us);
  DrawValue[~us] = VALUE_DRAW + Eval::contempt(phase, us);
