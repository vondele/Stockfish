...
void Thread::search() {
         ...
         && !(Limits.depth && mainThread && rootDepth > Limits.depth))
  {
          ...
          && !mainThread->stopOnPonderhit)
      {
          ...
          double pvLength = Depth(mainThread->rootMoves[0].pv.size() * 2) > mainThread->completedDepth * 3 ? 0.8 :
                            Depth(mainThread->rootMoves[0].pv.size() * 2) < mainThread->completedDepth     ? 1.2 :  1.0;
