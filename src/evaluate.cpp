...
make_v:
  ...
  const int scale01=1069, scale02=69;
  const int classical01=2119;
  const int complex01=257, complex02=282, complex03=71;
  const int optimism01=270;
  const int scale03=736;
