...
#undef S
  ...
  Value Evaluation<T>::value() {
    ...
    if (abs(v) > LazyThreshold + pos.non_pawn_material() / 64)
       return (pos.side_to_move() == WHITE ? v : -v) * msb(115 - pos.rule50_count()) / 6;
    ...
    return ((pos.side_to_move() == WHITE ? v : -v) + Eval::Tempo) * msb(115 - pos.rule50_count()) / 6; // Side to move point of view
  }
