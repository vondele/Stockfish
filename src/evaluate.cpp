...
make_v:
  ...
  const int scale01=1049, scale02=76;
  const int classical01=2172;
  const int complex01=310, complex02=314, complex03=69;
  const int optimism01=267;
  const int scale03=788;
