...
Value Eval::evaluate(const Position& pos) {
  ...
  int  scalePSQ = (pos.state()->previous && pos.state()->previous->accumulator.computed_accumulation) ? 14 : 20;

  bool useClassical = abs(eg_value(pos.psq_score())) * scalePSQ > NNUEThreshold1 * (16 + pos.rule50_count());
