...
MovePicker::MovePicker(const Position& p, Move ttm, Depth d, Move cm, Move kllrs[2], const ButterflyHistory* h,
                       const PieceToHistory* pth1, const PieceToHistory* pth2, const PieceToHistory* pth4)
           : pos(p), depth(d), history(h), cmh(pth1), fmh(pth2), fm2(pth4), killers{kllrs[0],kllrs[1]}, countermove(cm){
