...
MovePicker::MovePicker(const Position& p, Move ttm, Value th, const CapturePieceToHistory* cph, Square s)
           : pos(p), captureHistory(cph), recaptureSquare(s), threshold(th) {
